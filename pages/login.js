...
export function createLoginForm() {
  ...
  formContainer
    ...
    .addEventListener("submit", function (event) {
      ...
      //window.location.href = "setpassword-link";
    });
  ...
  formContainer.querySelector("#login-form").addEventListener("keydown", function (event) {
    if (event.key === "Enter") {
      event.preventDefault();
      formContainer.querySelector("#login-form").requestSubmit();
    }
  });
